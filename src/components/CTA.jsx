  ...
  return (
    <section className="py-20 md:py-32 bg-gradient-to-r from-accent-purple/10 to-accent-blue/10 border-t border-b border-gray-700">
      <div className="container-wide text-center">
        <h2 className="section-title mb-6">Ready to Transform Your Banking Operations?</h2>
        <p className="section-subtitle max-w-2xl mx-auto mb-12">
          Join hundreds of leading financial institutions that trust N7 for their digital transformation journey
        </p>
